    ...
    : AudioProcessorEditor(&ownerProc), processor(ownerProc)
{
    ...
    addAndMakeVisible (hzLabel = new Label ("Hertz Label",
                                            TRANS("Hz")));
    hzLabel->setFont (Font ("URW Gothic L", 22.40f, Font::plain));
    ...
    addAndMakeVisible (dbLabel = new Label ("Decibel Label",
                                            TRANS("dB")));
    dbLabel->setFont (Font ("URW Gothic L", 22.40f, Font::plain));
    ...
    highRangeLabel2->setBounds (30, 270, 125, 30);
    ...
    highRangeLabel3->setBounds (328, 160, 84, 32);
...
<JUCER_COMPONENT documentType="Component" className="ParagraphicEqAudioProcessorEditor"
  ...
  <LABEL name="Label for High Range" id="160bf294fa86114f" memberName="highRangeLabel3"
         virtualName="" explicitFocusOrder="0" pos="328 160 84 32" textCol="ff868686"
  ...
  <LABEL name="new label" id="c50597ba0b9a1e96" memberName="label" virtualName=""
         explicitFocusOrder="0" pos="172 -9 330 64" edTextCol="ff000000"
  ...
  <LABEL name="new label" id="7b25f2d252b59d64" memberName="label2" virtualName=""
         explicitFocusOrder="0" pos="488 8 75 40" edTextCol="ff000000"
  ...
  <SLIDER name="Q Factor Proportionality Slider" id="78d0015488cd36f7"
          ...
          pos="645 25 90 30" textboxbkgd="39000000" textboxhighlight="ff7e8ba1"
          textboxoutline="ff000000" min="0.00000000000000000000" max="10.00000000000000000000"
          int="0.00000000000000000000" style="LinearHorizontal" textBoxPos="TextBoxAbove"
